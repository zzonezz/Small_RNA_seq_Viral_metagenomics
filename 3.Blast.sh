...
export BLASTDB=/projectnb/lau-bumc/zhengzhu/BLASTDB
/projectnb/lau-bumc/zhengzhu/ncbi-blast-2.11.0+/bin/./blastn  -query $outputpath/starresults/$file -out $outputpath/blastresults/${file%.Unmapped.out.mate1}.blastn -db /projectnb/lau-bumc/zhengzhu/BLASTDB/nt -outfmt \"6 qseqid sacc evalue qstart qend qlen sstart send pident qcovs sskingdoms sscinames scomnames sblastnames\"  -max_target_seqs 1 -num_threads 28 -word_size 11
